...
export function About() {
    return (
        <section id="our-story" className="py-24 bg-white dark:bg-[#0a0a0a] overflow-hidden scroll-mt-20">
                    ...
                    <div className="space-y-12 text-lg md:text-xl text-gray-600 dark:text-gray-300 leading-relaxed font-light">
                        ...
                        <div className="grid md:grid-cols-2 gap-12 items-center py-8">
                            <ScrollReveal direction="left" delay={0.4}>
                                <div className="bg-gray-50 dark:bg-white/5 p-8 rounded-3xl border border-gray-100 dark:border-white/10 italic">
